    ...
    <>
      <div
        ...
        style={{
          ...
          top: 0,
          borderRadius: "50%",
          background: `radial-gradient(${largeGlow}px at center, rgba(59,130,246,0.08), rgba(139,92,246,0.04), transparent 65%)`,
      ...
      <div
        ...
        style={{
          ...
          top: 0,
          borderRadius: "50%",
          background: `radial-gradient(${midGlow * 0.45}px at center, rgba(6,182,212,0.05), rgba(59,130,246,0.03), transparent 60%)`,
