...
import { Download, ExternalLink, FileText, GraduationCap, MapPin, Calendar, Award } from "lucide-react";
...
const allSkills = [
  ...
  "Machine Learning", "AI Systems", "DSA", "Docker",
];
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-2 space-y-6">
            {education.map((edu, i) => (
              ...
              <div className="relative glass-card p-5 sm:p-6 space-y-3">
